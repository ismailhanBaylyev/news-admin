...
@endsection
<h1 class="mb-5"><a href="/news" class="text-muted">Статьи</a> / Добавить статью</h1>

<div class="card mb-4">
    <div class="card-body">
        <form id="formAccountSettings" action="/add-news" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3 col-lg-12 col-md-6">
                ...
                <input type="text" name="slug" class="form-control" id="name" placeholder="..." />
                <span class="text-danger">@error('name'){{$message}}@enderror<span>
            </div>
            <div class="mb-3 col-lg-12 col-md-6">
                ...
                <input type="hidden" class="content-value" name="content" value="">
            </div>
